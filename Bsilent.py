...
async def start_flash():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await idk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await idk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await idk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await idk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ydk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ydk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ydk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ydk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await wdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await wdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await wdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await wdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await hdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await hdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await hdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await hdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await sdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await sdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await sdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await sdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await adk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await adk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await adk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await adk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await bdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await bdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await bdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await bdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await cdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await cdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await cdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await cdk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ddk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ddk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ddk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ddk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await edk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await edk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await edk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await edk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await vkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await vkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await vkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await vkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await kkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await kkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await kkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await kkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await lkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await lkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await lkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await lkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await mkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await mkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await mkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await mkk(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await sid(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await sid(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await sid(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await sid(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await shy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await shy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await shy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await shy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await aan(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await aan(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await aan(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await aan(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ake(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ake(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ake(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await ake(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await eel(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await eel(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await eel(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await eel(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await khu(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await khu(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await khu(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await khu(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await shi(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await shi(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await shi(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await shi(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await yaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await yaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await yaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await yaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await dav(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await dav(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await dav(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await dav(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await raj(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await raj(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await raj(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await raj(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await put(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await put(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await put(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await put(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if tsix:
        ...
        try:
            ...
            await eag(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await eag(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await eag(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await eag(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await eag(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if tseven:
        ...
        try:
            ...
            await gle.start()
            await gle(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await gle(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await gle(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await gle(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await gle(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if teight:
        ...
        try:
            ...
            await wal.start()
            await wal(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await wal(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await wal(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await wal(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await wal(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if tnine:
        ...
        try:
            ...
            await aaa.start()
            await aaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await aaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await aaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await aaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await aaa(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
    ...
    if thirty:
        ...
        try:
            ...
            await boy.start()
            await boy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await boy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await boy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await boy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
            await boy(functions.channels.JoinChannelRequest(channel="@bsilent_9d1563cb"))
...
async def stats(event):
   ...
   if event.sender_id in SMEX_USERS:    
       ...
       # await event.edit("`Processing..`")
        ...
        flash += f"🔻 **HERE IS YOUR BSILENT-SPAM-BOTS STATS** 🔻\n\n"
        flash += f"`Users:`\t**{u}**\n"
        flash += f"`Groups:`\t**{g}**\n"
...
async def dm(e):   
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(flash) == 2:
            ...
            g = a.id
            if int(g) in FlashX:
                text = f"I can't Dm to @ahmed15basher's Owner"
                await e.reply(text, parse_mode=None, link_preview=None )
...
async def dmraid(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(flash) == 2:
            ...
            g = a.id
            if int(g) in FlashX:
                text = f"I can't raid on @ahmed15basher's Owner"
                await e.reply(text, parse_mode=None, link_preview=None )
            elif int(g) in SMEX_USERS:
                text = f"This guy is a sudo user."
                await e.reply(text, parse_mode=None, link_preview=None )
...
async def get_users(event):
    if event.sender_id in SMEX_USERS:
        Nobi = event.text[11:]
        flash = Nobi.lower()
        restricted = ["@bsilent_9d1563cb", "@Injector_7H", "@Xlr8Cheats_Chat"]
...
text = """
 𝙂𝙤 𝘿𝙤 .𝙥𝙞𝙣𝙜 𝙖𝙩 @bsilent_9d1563cb
𝗕𝗬 @ahmed15basher """
